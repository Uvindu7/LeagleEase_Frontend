  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg h-80 flex flex-col items-center justify-center border border-gray-200 hover:shadow-xl transition cursor-pointer">
      ...
      <div className="flex flex-col items-center mb-4">
        <ShieldCheckIcon className="w-12 h-12 text-[#3e352a] mb-2" />
        <h2 className="text-2xl font-extrabold text-[#3e352a] tracking-wide">Lawyer Verification</h2>
      </div>

      {/* Description or Placeholder */}
      <p className="text-gray-500 text-center px-4">
        Manage and verify lawyer profiles. Click to view pending verification requests.
      </p>
    </div>
  );
};
